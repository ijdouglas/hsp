...
const a_option = '<img src="data/images/image_a_option.jpg" width="60" height="50" border="0" alt="javascript button">'
const b_option = '<img src="data/images/image_b_option.jpg" width="50" height="50" border="0" alt="javascript button">'
const both_option = '<img src="data/images/image_both_option.jpg" width="70" height="70" border="0" alt="javascript button">'
const neither_option = '<img src="data/images/image_neither_option.jpg" width="80" height="80" border="0" alt="javascript button">'
