...
var inst1 = [`
    <h1>Instructions</h1>
    <p align="justify">You will be asked to watch some short videos of parents playing toys with their children. These videos are action verb naming instances selected from the toy-play interaction, which means that parent in the video named an action verb. The sound of each video is computer generated, and a beep is inserted at the onset of the verb that parent named. Your job is to carefully watch the video and then guess the verb that parents meant to say, indicated at the beep.</p>`];
...
jsPsych.plugins['hsp-true-false'] = (function () {
