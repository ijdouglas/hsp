...
var instructions2 = {
    ...
    stimulus: `
    <h1>Instructions</h1>
    <p align="justify">You will be asked to watch some short videos of parents playing with toys with their children. These videos are taken from instances when parents said an <b>action verb</b> during the toy-play interaction, which means that the parent in the video said an action verb. The sound of each video is removed, and a beep is inserted where the parent had said the verb. Your job is to carefully watch the video and then guess the verb that the parent said at the moment of the beep.</p>

    <p align="justify">Please keep in mind that the verbs you are asked to guess are all <b>concrete action verbs</b> such as jump or clap. We are not asking you to guess abstract and generic verbs like "think", "see/look", "do", or "make". Please enter correctly spelled <b>English</b> verbs in their <b>present tense form only</b>.</p>

    <p align="justify">Each video will only be played once, so make sure you pay close attention to the entire video and only start typing your answer after the video has finished. After the video, you have 20 seconds to enter your response. If you are unsure or do not know, please still try to provide your best guess within 20 seconds. If you did not enter a valid answer after 20 seconds, the next trial will start. If you <b>miss 5 consecutive trials</b>, the study will automatically stop.</p>
