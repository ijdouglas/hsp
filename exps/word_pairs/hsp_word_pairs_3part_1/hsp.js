...
var instructions3 = {
    ...
    stimulus: `
    <h1>Instructions</h1>
    <p align="justify">You will be shown ~165 pairs of verbs. Your job is to carefully rate the similarity of the two verbs on a scale from 1 to 7 (1 = very different, 7 = very similar).</p>
